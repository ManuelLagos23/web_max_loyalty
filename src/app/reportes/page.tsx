...
export default function Reportes() {
  ...
  const exportToExcel = () => {
    ...
    const worksheetData = [
      { A: `Fecha Inicio: ${fechaInicio || 'N/A'}` },
      { A: `Fecha Final: ${fechaFinal || 'N/A'}` },
      { A: `Establecimiento: ${establecimientoNombre}` },
      {}, // Empty row
      ...transacciones.map((t) => ({
        Canal: t.canal ?? 'N/A',
          ...
          <main className="flex-1 p-8">
            <div className="space-y-6">
              ...
              <p className="text-center text-gray-700 leading-relaxed max-w-2xl p-4 rounded-lg transition-all duration-300 hover:shadow-md mx-auto">
                Genera reportes de transacciones seleccionando un rango de fechas y un establecimiento.
              </p>
            </div>
            ...
            <div className="mt-6 bg-gray-100 p-6 rounded-lg shadow-md">
              ...
              <button
                ...
                className={`w-full md:w-auto px-4 py-2 rounded-lg text-white font-medium transition-all duration-300 ${
